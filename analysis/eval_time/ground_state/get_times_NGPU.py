...
datapath = ""
name_times = ['Build', 'Simulation', 'neuron_Update_time',
...
for filename in name_times:
    ...
    #print("Getting data from"+fn)
    times.append(np.loadtxt(fn))
    #compute names
    if (filename == "Build"):
...
for i in range(10):
    ...
    #sometimes there is more than one node that exibit the maximum value
